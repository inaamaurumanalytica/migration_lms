...
@Component({
    selector: 'client-project-create-modal',
    templateUrl: './client-project-create-modal.component.html',
    styleUrls: ['./client-project-create-modal.component.scss']
})
export class ClientProjectCreateModalComponent implements OnInit, AfterViewInit {
    ...
    constructor(
        ...
        private dialogRef: MatDialogRef<ClientProjectCreateModalComponent>,
    ) {
    ...
    save() {
        let body = {
            ...
            "client_id": this.createProjectForm.value.client.id,
            "project_type": this.createProjectForm.value.project_type,
            "min_price": this.createProjectForm.value.min_price,
            "rera_id": this.createProjectForm.value.rera_id,
            "latitude": this.createProjectForm.value.latitude,
            "longitude": this.createProjectForm.value.longitude
        }
        this.btnStatus = true
        this.serverService.createProject(body, this.authToken).subscribe(
            data => {
                this.btnStatus = false
                this.clipBoardService.showMessgeInText('Project Created Successfully', 'success-snackbar')
