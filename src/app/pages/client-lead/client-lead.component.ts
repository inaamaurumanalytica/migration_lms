...
import { ClientLeadCreateModalComponent } from './client-lead-create-modal/client-lead-create-modal.component'
import { ClientLeadEditModalComponent } from './client-lead-edit-modal/client-lead-edit-modal.component'
import { ClientLeadInfoModalComponent } from './client-lead-info-modal/client-lead-info-modal.component'
import { ClientRemarkModalComponent } from './client-remark-modal/client-remark-modal.component'
import { ClientUploadModalComponent } from './client-upload-modal/client-upload-modal.component'
import { ClientExportLeadModalComponent } from './client-export-lead-modal/client-export-lead-modal.component'
import { ClientLeadDeleteModalComponent } from './client-lead-delete-modal/client-lead-delete-modal.component'
import { ClientLeadWebhookCreateModalComponent } from './client-lead-webhook-create-modal/client-lead-webhook-create-modal.component';
import { ClientAssignLeadModalComponent } from './client-assign-lead-modal/client-assign-lead-modal.component';
import { ClientLeadTransferModalComponent } from './client-lead-transfer-modal/client-lead-transfer-modal.component';
...
import { SetLeadColorModalComponent } from './set-lead-color-modal/set-lead-color-modal.component';
import { AppointmentModalComponent } from './appointment-modal/appointment-modal.component';
import { CopyLeadModalComponent } from './copy-lead-modal/copy-lead-modal.component';
import { CallsListModalComponent } from './calls-list-modal/calls-list-modal.component';
import { SelectionModel } from '@angular/cdk/collections';
import { CopyMultipleLeadModalComponent } from './copy-multiple-lead-modal/copy-multiple-lead-modal.component';
import { AdminProjectModalComponent } from './admin-project-modal/admin-project-modal.component';
import { ConfirmLeadModalComponent } from './confirm-lead-modal/confirm-lead-modal.component';
...
import { AdminClientProjectModalComponent } from './admin-client-project-modal/admin-client-project-modal.component';
...
import { LeadDuplicateInfoComponent } from './lead-duplicate-info/lead-duplicate-info.component';
...
import { PreviewNumberModalComponent } from './preview-number-modal/preview-number-modal.component';
...
export class ClientLeadComponent {
  ...
  project: any = JSON.parse(sessionStorage.getItem("projectInfo"));
  ...
  constructor(
    ...
    this.titleService.setTitle(this.project.name+' | '+this.project.client_name+' | '+"AutomateLeads")
    ...
    if (sessionStorage.getItem("projectInfo") == undefined) {
      this.router.navigate(['page/project']);
      return;
    } else {
      this.clipBoardService.projectInfo = JSON.parse(sessionStorage.getItem("projectInfo"));
  ...
  getProjectById() {
    this.serverService.getProjectById(this.project, this.authToken).subscribe(
      data => {
        ...
        this.project.client_name = data.client.name;
        this.getAllLeads()
      },
      err => {
  ...
  getAllLeads() {
    ...
    this.role == 'SalesAdmin'?
    url = "sales/leads_search?per_page=" + this.pageSize + "&page=" + this.pageIndex:
    url = "leads_search?per_page=" + this.pageSize + "&page=" + this.pageIndex;
  ...
  openWhatsappDialog(element) {
		this.dialog.open(PreviewNumberModalComponent, {
			hasBackdrop: true,
			disableClose: true,
			autoFocus: true,
			data: element,
